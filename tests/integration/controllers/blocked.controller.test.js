...
import { addBlockedUser, removeBlockedUser, getBlockedUsers } from '../../../src/api/controllers/blocked.controller.js';
...
describe('Blocked Users Controller', () => {
    ...
    describe('addBlockedUser', () => {
        it('should block a user successfully', async () => {
            ...
            expect(res.json.calledWith({ message: 'User blocked successfully' })).to.be.true;
    ...
    describe('getBlockedUsers', () => {
        it('should get the list of blocked users successfully', async () => {
            ...
            expect(res.status.calledWith(200)).to.be.true;
            expect(res.json.calledOnce).to.be.true;
            expect(res.json.args[0][0].blockedUsers[0]).to.have.property('username', 'user2');
            expect(res.json.args[0][0].blockedUsers[0]).to.have.property('email', 'user2@example.com');
        });
